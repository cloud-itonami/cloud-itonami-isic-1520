# Operator Quickstart — Manufacture of footwear

Shortest path from clone to a verified local dry-run for **ISIC 1520** (`cloud-itonami-isic-1520`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1520.git
cd cloud-itonami-isic-1520
```
...
- Blueprint governor key: `footwear-plant-operations-governor`
- Likely source path: `footwearops.governor.cljc`
