# Business Model: Manufacture of footwear
...
## Classification
- Repository: `cloud-itonami-isic-1520` ([github.com/cloud-itonami/cloud-itonami-isic-1520](https://github.com/cloud-itonami/cloud-itonami-isic-1520))
- ISIC Rev.5: `1520` — Manufacture of footwear
- Domain: `:footwear/manufacturing`
- Social impact: :worker-safety :labor-standards :materials-traceability
- Actor: `:footwear-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :footwear/manufacturing — who wants
...
One managed tenant (:footwear/manufacturing):
...
- Do not bypass the `:footwear-plant-operations-governor` for production decisions.
